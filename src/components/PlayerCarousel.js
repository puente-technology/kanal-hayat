  ...
  render() {
    ...
    return (
      <div id="player-carousel" className="noselect">
        <button type="button" className="arrow arrow-left-programmlar" onClick={this.leftClick}><img src={arrovSvg} alt="LeftArrow" /></button>
        ...
        <button type="button" className="arrow arrow-right-programmlar" onClick={this.rightClick}><img src={arrovSvg} alt="RightArrow" /></button>
      </div>
    )
  }
}
